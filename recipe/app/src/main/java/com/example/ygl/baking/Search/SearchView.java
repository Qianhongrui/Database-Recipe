...
import static com.example.ygl.baking.SearchActivity.search_string;
...
public class SearchView extends LinearLayout {
    ...
    // 回调接口
    private com.example.ygl.baking.Search.ICallBack mCallBack;// 搜索按键回调接口
    private com.example.ygl.baking.Search.bCallBack bCallBack; // 返回按键回调接口
     ...
     * 点击返回后的操作，用于接口回调
     */
    public void setOnClickBack(com.example.ygl.baking.Search.bCallBack bCallBack){
