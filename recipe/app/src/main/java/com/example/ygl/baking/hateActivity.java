...
public class hateActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>,SyncAdapter.BadNews{
    private static final String TAG = "favorActivity";
    private List<Blacklist> recipeList;
    private Recipe_hateAdapter recipeAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recipeList= DataSupport.findAll(Blacklist.class);
        if(recipeList.size()<=0){
            recipeList.removeAll(recipeList);
            syncData();
        }else {
            recipeAdapter=new Recipe_hateAdapter(recipeList,emptyPrompt);
        ...
        FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.return_hate);
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent();
                intent.setClass(hateActivity.this, MainActivity.class);
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle){
        ...
        return new CursorLoader(hateActivity.this, StubProvider.BlacklistUri,null,null,null,null);
    }
    @Override
    ...
    private void syncData(){
        emptyPrompt.setText(R.string.no_hate);
        ...
        /*if(Util.isNetworkConnected(this)){
            ...
            emptyPrompt.setTextColor(getResources().getColor(R.color.dimgray));
            emptyPrompt.setOnClickListener(null);
            SyncAdapter.CreateSyncAccount(hateActivity.this);
        }else {
