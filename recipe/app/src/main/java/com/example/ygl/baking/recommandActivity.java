...
public class recommandActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>, SyncAdapter.BadNews {
    private static final String TAG = "recommandActivity";
    private List<Recipe> recipeList;
    private RecommandAdapter recipeAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (recipeList.size() <= 0) {
            ...
            recipeAdapter = new RecommandAdapter(recipeList, emptyPrompt);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.setClass(recommandActivity.this, MainActivity.class);
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        ...
        return new CursorLoader(recommandActivity.this, StubProvider.FavorUri, null, null, null, null);
    }
