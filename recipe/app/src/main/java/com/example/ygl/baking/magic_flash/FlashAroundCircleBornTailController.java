...
public class FlashAroundCircleBornTailController extends FlashBaseController {
    private String mColor = "#2196F3";
    private String mColorTran = "#FFFFFF";
    private int mAngle = 10;
    private RectF mRectF;
    private int cx, cy, cr;

    public FlashAroundCircleBornTailController() {
        mRectF = new RectF();
    }
